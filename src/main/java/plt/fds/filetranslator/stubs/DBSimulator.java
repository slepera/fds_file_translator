...
public class DBSimulator {
    ...
    public static ManoeuvrePlan getManoeuvrePlan()
    {
        ...
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfHeader.taskName = "taskname???01234567$$$$$$$";
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfHeader.taskType = "9$$$$";
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfHeader.parameterSetName = "setname0??";
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfHeader.parameterValueSetName = "valueset??name";
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfHeader.destination = "d";
        ...
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfHeader.releaseTime = "releasetime012345678?????9012345";
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfHeader.earliestReleaseTime = "earliestreleasetime9????8765432109876543210";
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfHeader.latestReleaseTime = "latestreleasetime012???34567890123456789";
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfHeader.executionTime = "executiontime0123456????7890123456789$$$$$$";
        ...
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfBody.tpfRecord.get(0).paramName = "paramnam????e01234567";
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfBody.tpfRecord.get(0).paramValueType = "9$$$";
        ...
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfBody.tpfRecord.get(1).paramValue = "paramValue0123456789????????0123456789";
        manoeuvrePlan.manLeg.get(0).orbitalManoeuvre.get(1).tpf.get(1).tpfBody.tpfRecord.get(1).paramValueUnit = "unit????3235";
    ...
    public static TPF getTPF(){
        ...
        tpf.tpfHeader.taskName = "taskname???01234567$$$$$$$";
        tpf.tpfHeader.taskType = "9$$$$";
        tpf.tpfHeader.parameterSetName = "setname0??";
        tpf.tpfHeader.parameterValueSetName = "valueset??name";
        tpf.tpfHeader.destination = "d";
        tpf.tpfHeader.source = "s";
        tpf.tpfHeader.nbRecords = 157;
        tpf.tpfHeader.releaseTime = "releasetime012345678?????9012345";
        tpf.tpfHeader.earliestReleaseTime = "earliestreleasetime9????8765432109876543210";
        tpf.tpfHeader.latestReleaseTime = "latestreleasetime012???34567890123456789";
        tpf.tpfHeader.executionTime = "executiontime0123456????7890123456789$$$$$$";
        ...
        tpf.tpfBody.tpfRecord.get(0).paramName = "paramnam????e01234567";
        tpf.tpfBody.tpfRecord.get(0).paramValueType = "9$$$";
        tpf.tpfBody.tpfRecord.get(0).paramValue = "paramValue0123456789????????0123456789";
        tpf.tpfBody.tpfRecord.get(0).paramValueUnit = "unit????3235";
        ...
        tpf.tpfBody.tpfRecord.get(1).paramValue = "paramValueabcdefghijklmñnopqrt";
