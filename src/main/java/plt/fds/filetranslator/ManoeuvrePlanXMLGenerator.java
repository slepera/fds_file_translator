...
public class ManoeuvrePlanXMLGenerator {
    ...
    public static void GenerateManoeuvreFileXML(ManoeuvrePlan mp) throws IOException {
        ...
        for (int i = 0; i < manoeuvrePlan.manLeg.length; i++) {
            ...
            for (int j = 0; j < manoeuvrePlan.manLeg[i].attitudeManoeuvre.length; j++) {
                ...
                CreateAttitudeManouvre(attitudeManoeuvre, i, j);
            ...
            for (int j = 0; j < manoeuvrePlan.manLeg[i].orbitalManoeuvre.length; j++) {
                ...
                CreateOrbitalManouvre(orbitalManoeuvre, i, j);
    ...
    private static void CreateAttitudeManouvre(Element attitudeManoeuvre, int i, int j) {
    ...
    private static void CreateOrbitalManouvre(Element orbitalManoeuvre, int i, int j) {
